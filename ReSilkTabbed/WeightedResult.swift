//
//  WeightedResult.swift
//  ReSilkTabbed
//
//  Created by Liam Murray on 19/03/2019.
...
class WeightedResult: UIViewController {
    //Creating a Reference for the TableView in the first ViewController
    
    @IBOutlet weak var weightedResult: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        weightedResult.text = String(userInputResults.resultWeighted)
